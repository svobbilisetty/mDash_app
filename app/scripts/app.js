  ...
  .config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    .state('app.mail.compose', {
	 ...
	 .state('app.projects', {
      url: '/projects',
      controller: 'MailComposeCtrl',
      templateUrl: 'views/tmpl/projects/projects.html'
    })
    //mail/single
    ...
    .state('app.roles', {
      ...
      templateUrl: 'views/tmpl/roles.html',
      resolve: {
        plugins: ['$ocLazyLoad', function($ocLazyLoad) {
          return $ocLazyLoad.load([
            'scripts/vendor/datatables/datatables.bootstrap.min.css',
    ...
    .state('app.users', {
      ...
      templateUrl: 'views/tmpl/users.html',
      resolve: {
        plugins: ['$ocLazyLoad', function($ocLazyLoad) {
          return $ocLazyLoad.load([
            'scripts/vendor/filestyle/bootstrap-filestyle.min.js'
	...
	.state('app.viewjob', {
      url: '/viewjob',
	  controller: 'viewjob',
      templateUrl: 'views/tmpl/viewflow.html',
    })
	...
	.state('app.addLibraryProperties', {
      url: '/addLibraryProperties',
	  controller: 'addLibraryProperties',
      templateUrl: 'views/tmpl/addLibraryProperties.html',
    })
	
	/* .state('app.configurationsPage', {
      url: '/configurationsPage',
	  controller: 'configurationsPage',
      templateUrl: 'views/tmpl/configurationsPage.html',
    }) */
	.state('app.configurationsPage', {
      url: '/configurationsPage',
	...
	.state('app.projectbuild', {
      url: '/projectbuild',
      controller: 'VectorMapCtrl',
      templateUrl: 'views/tmpl/projectbuild.html',
      resolve: {
        plugins: ['$ocLazyLoad', function($ocLazyLoad) {
          return $ocLazyLoad.load([
            'scripts/vendor/jqvmap/jqvmap/jquery.vmap.min.js',
